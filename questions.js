...
const cloudQuestions = [
  {
    ...
    question: "Which statement best defines cloud computing according to NIST?",
    options: ["A synonym for virtualization", "On-demand network access to a shared pool of configurable computing resources", "Any service delivered over the internet", "Renting only physical servers"],
    correct: 1,
    explanation: "NIST defines cloud computing as on-demand self-service, broad network access, resource pooling, rapid elasticity, and measured service."
  },
  {
    topic: "Cloud Fundamentals",
    question: "Which is NOT an essential characteristic of cloud computing?",
    options: ["On-demand self-service", "Broad network access", "Fixed capacity provisioning", "Measured service"],
    correct: 2,
    explanation: "Cloud relies on rapid elasticity and on-demand resources, not fixed capacity provisioning."
  },
  {
    topic: "Cloud Fundamentals",
    question: "What is the main difference between virtual machines and containers?",
    options: ["VMs share the host OS; containers do not", "Containers share the host OS kernel; VMs each have their own OS", "There is no difference", "Containers are slower than VMs"],
    correct: 1,
    explanation: "Containers package applications and dependencies but share the host kernel, making them lighter than VMs."
  },
  {
    topic: "Cloud Fundamentals",
    question: "Elasticity in cloud computing is:",
    options: ["Ability to handle load manually", "Automatic provisioning and de-provisioning of resources to match demand", "Long-term capacity planning", "Fault tolerance"],
    correct: 1,
    explanation: "Elasticity automatically scales resources up and down with current demand."
  },
  {
    topic: "Cloud Fundamentals",
    question: "Scalability differs from elasticity because scalability is:",
    options: ["The ability to increase capacity to handle growth", "Temporary by definition", "Only vertical scaling", "Only automatic"],
    correct: 0,
    explanation: "Scalability is the ability to grow over time; elasticity is automatic short-term matching of demand."
  },
  {
    topic: "Cloud Fundamentals",
    question: "High availability means:",
    options: ["No downtime ever", "A system remains operational with minimal downtime despite failures", "Data is never lost", "Performance is always fast"],
    correct: 1,
    explanation: "High availability uses redundancy to avoid single points of failure and reduce downtime."
  },
  {
    topic: "Cloud Fundamentals",
    question: "Fault tolerance is:",
    options: ["The system continues operating with zero downtime even if a component fails", "The system recovers within RTO", "Only taking regular backups", "Load balancing"],
    correct: 0,
    explanation: "Fault tolerance uses redundant components to continue operating without interruption."
  },

  {
    topic: "Cloud Service Models",
    question: "Which service model gives the customer the most control over the operating system and runtime?",
    options: ["SaaS", "PaaS", "IaaS", "Serverless"],
    correct: 2,
    explanation: "IaaS provides virtualized infrastructure; the customer manages OS, middleware, runtime, and data."
  },
  {
    topic: "Cloud Service Models",
    question: "Which is an example of PaaS?",
    options: ["AWS EC2", "Google App Engine", "Microsoft 365", "Amazon S3"],
    correct: 1,
    explanation: "PaaS platforms like Google App Engine let you deploy code without managing the underlying infrastructure."
  },
  {
    topic: "Cloud Service Models",
    question: "Which is an example of SaaS?",
    options: ["Azure SQL Database", "Google Kubernetes Engine", "Salesforce", "AWS Lambda"],
    correct: 2,
    explanation: "SaaS delivers ready-to-use applications over the internet, such as Salesforce."
  },
  {
    topic: "Cloud Service Models",
    question: "Serverless computing means:",
    options: ["No servers exist anywhere", "The cloud provider fully manages server provisioning and scaling; you pay per invocation", "It is only for static websites", "You must manage virtual machines manually"],
    correct: 1,
    explanation: "Serverless abstracts servers, automatically scales, and charges based on execution or requests."
  },

  {
    topic: "Cloud Deployment Models",
    question: "A public cloud is best described as:",
    options: ["Cloud services shared among multiple organizations", "Dedicated infrastructure for one organization", "On-premises only", "Only open-source cloud software"],
    correct: 0,
    explanation: "Public cloud resources are owned and operated by a provider and shared across multiple tenants."
  },
  {
    topic: "Cloud Deployment Models",
    question: "A private cloud is:",
    options: ["Public internet only", "Dedicated infrastructure for a single organization", "A free cloud tier", "A community cloud only"],
    correct: 1,
    explanation: "Private cloud is dedicated infrastructure used exclusively by one organization, on-premises or hosted."
  },
  {
    topic: "Cloud Deployment Models",
    question: "Hybrid cloud refers to:",
    options: ["Using multiple public clouds only", "Combining private and public cloud with orchestration", "On-premises only", "Two physical data centers"],
    correct: 1,
    explanation: "Hybrid cloud connects private and public environments to share data and applications."
  },
  {
    topic: "Cloud Deployment Models",
    question: "Multi-cloud means:",
    options: ["Multiple regions in one provider", "Using multiple cloud providers", "Multiple availability zones", "Using public and private cloud together"],
    correct: 1,
    explanation: "Multi-cloud is the use of two or more cloud providers, often to avoid vendor lock-in."
  },
  {
    topic: "Cloud Deployment Models",
    question: "A bank must keep sensitive workloads on-premises for compliance but wants cloud for analytics. Which model fits?",
    options: ["Hybrid cloud", "Public cloud only", "Private cloud only", "No cloud at all"],
    correct: 0,
    explanation: "Hybrid cloud keeps sensitive data on-prem while using public cloud for scalable analytics."
  },

  {
    topic: "Cloud DR & Backup",
    question: "RPO (Recovery Point Objective) defines:",
    options: ["Maximum acceptable downtime", "Maximum acceptable data loss measured in time", "Time to restore service", "Backup frequency"],
    correct: 1,
    explanation: "RPO is the maximum tolerable amount of data loss, often expressed in minutes or hours."
  },
  {
    topic: "Cloud DR & Backup",
    question: "RTO (Recovery Time Objective) defines:",
    options: ["Maximum acceptable data loss", "Maximum acceptable time to restore service after an outage", "Time to detect a failure", "Backup window"],
    correct: 1,
    explanation: "RTO is the target duration for restoring service after a disruption."
  },
  {
    topic: "Cloud DR & Backup",
    question: "A pilot light disaster recovery strategy means:",
    options: ["Minimal core services are running and ready to scale up during recovery", "Fully active in multiple regions", "Backups only with no resources running", "No disaster recovery plan"],
    correct: 0,
    explanation: "Pilot light keeps a small footprint ready, then scales up during a failover."
  },
  {
    topic: "Cloud DR & Backup",
    question: "Compared with pilot light, warm standby DR:",
    options: ["Has a larger pre-provisioned environment running at lower capacity", "Is exactly the same", "Is completely cold", "Is always full-size active-active"],
    correct: 0,
    explanation: "Warm standby is more ready than pilot light but costs more because more resources run continuously."
  },
  {
    topic: "Cloud DR & Backup",
    question: "An application requires RPO=0 and RTO < 15 minutes. Which strategy is likely needed?",
    options: ["Nightly backups only", "Continuous synchronous replication and automated failover to a warm/hot standby", "Offline tape backups", "Manual restore from a snapshot"],
    correct: 1,
    explanation: "RPO=0 requires synchronous replication; low RTO requires automated, ready standby resources."
  },
  {
    topic: "Cloud DR & Backup",
    question: "A global system needs disaster recovery across regions with automatic failover and minimal data loss. Which architecture is best?",
    options: ["Active-active or hot standby multi-region with replication", "Pilot light with manual failover", "Backups only", "Single region multi-AZ only"],
    correct: 0,
    explanation: "Multi-region active-active or hot standby with replication meets low RPO and RTO for region failures."
  },

  {
    topic: "Cloud Architecture",
    question: "What is the primary purpose of a load balancer?",
    options: ["Store data", "Distribute traffic across multiple targets", "Encrypt data", "Monitor logs"],
    correct: 1,
    explanation: "Load balancers distribute incoming traffic to improve availability, fault tolerance, and performance."
  },
  {
    topic: "Cloud Architecture",
    question: "An Auto Scaling group is used to:",
    options: ["Automatically adjust the number of compute instances based on demand", "Manually scale database storage", "Reduce network latency", "Manage DNS records"],
    correct: 0,
    explanation: "Auto Scaling maintains desired capacity and scales in or out based on demand or schedules."
  },
  {
    topic: "Cloud Architecture",
    question: "An API Gateway in microservices is used to:",
    options: ["Store microservices code", "Provide a single entry point for routing, authentication, and rate limiting API requests", "Compile code", "Manage databases"],
    correct: 1,
    explanation: "API Gateways centralize cross-cutting concerns and route requests to backend services."
  },
  {
    topic: "Cloud Architecture",
    question: "Microservices architecture means:",
    options: ["One large monolithic application", "An application split into small, independent services communicating via APIs", "Only serverless functions", "A single deployment artifact"],
    correct: 1,
    explanation: "Each microservice can be developed, deployed, and scaled independently."
  },
  {
    topic: "Cloud Architecture",
    question: "What is a cloud landing zone?",
    options: ["A physical data center", "A pre-configured multi-account environment with security, networking, and identity baselines", "A CDN edge location", "A load balancer"],
    correct: 1,
    explanation: "A landing zone establishes a secure foundation for deploying workloads in the cloud."
  },
  {
    topic: "Cloud Architecture",
    question: "Which pillars are part of the AWS Well-Architected Framework?",
    options: ["Cost, Security, Reliability, Performance Efficiency, Operational Excellence, Sustainability", "Only Security", "Only Cost", "Agile and Lean only"],
    correct: 0,
    explanation: "These pillars guide architectural reviews and best practices."
  },
  {
    topic: "Cloud Architecture",
    question: "To protect a web application against an Availability Zone failure, which design should be used?",
    options: ["Deploy across multiple Availability Zones behind a load balancer", "Deploy in a single Availability Zone", "Use only snapshots", "Use a single server"],
    correct: 0,
    explanation: "Multi-AZ deployment provides high availability if one AZ fails."
  },
  {
    topic: "Cloud Architecture",
    question: "A company wants to avoid vendor lock-in. Which approach helps most?",
    options: ["Use open-source container platforms and multi-cloud compatible services", "Use as many proprietary APIs as possible", "Use a single provider only", "Avoid containers entirely"],
    correct: 0,
    explanation: "Containers and open standards increase portability across cloud providers."
  },
  {
    topic: "Cloud Architecture",
    question: "To scale worker instances based on the number of messages in a queue, use:",
    options: ["CPU utilization only", "Auto scaling with a custom metric for queue depth", "A manual schedule only", "DNS changes"],
    correct: 1,
    explanation: "Queue depth is a better signal for asynchronous processing and enables accurate scaling."
  },

  {
    topic: "Cloud Networking",
    question: "An Availability Zone (AZ) is:",
    options: ["A country where cloud is available", "An isolated location with one or more data centers within a region", "An edge location", "A billing zone"],
    correct: 1,
    explanation: "AZs are isolated fault domains inside a region, providing resilience within a geographic area."
  },
  {
    topic: "Cloud Networking",
    question: "A cloud region is:",
    options: ["A single data center", "A geographical area with multiple Availability Zones", "A CDN point of presence", "A network subnet"],
    correct: 1,
    explanation: "A region contains multiple AZs for low-latency and fault isolation."
  },
  {
    topic: "Cloud Networking",
    question: "A Content Delivery Network (CDN) is used to:",
    options: ["Run databases", "Cache content closer to users to reduce latency", "Manage identity and access", "Store backups"],
    correct: 1,
    explanation: "CDNs cache static or dynamic content at edge locations closer to end users."
  },
  {
    topic: "Cloud Networking",
    question: "A Virtual Private Cloud (VPC) is:",
    options: ["A physical private network", "A logically isolated virtual network in a public cloud", "Only a VPN connection", "The public internet"],
    correct: 1,
    explanation: "A VPC lets you define your own IP ranges, subnets, route tables, and gateways in the cloud."
  },
  {
    topic: "Cloud Networking",
    question: "A public subnet in a VPC is one that:",
    options: ["Has no route table", "Has a route to an internet gateway", "Cannot access the internet", "Is accessible only on-premises"],
    correct: 1,
    explanation: "Public subnets have a route to the internet gateway, allowing direct internet access."
  },
  {
    topic: "Cloud Networking",
    question: "In a three-tier VPC design, database servers should be placed in:",
    options: ["A public subnet", "A private subnet with no direct internet access", "A DMZ only", "An edge location"],
    correct: 1,
    explanation: "Databases should be isolated in private subnets; only application or load balancer tiers should be public."
  },
  {
    topic: "Cloud Networking",
    question: "A NAT gateway is used to:",
    options: ["Allow private instances to initiate outbound internet traffic without exposing inbound access", "Route on-premises traffic", "Load balance traffic", "Store objects"],
    correct: 0,
    explanation: "NAT enables outbound-only internet access for private resources while hiding their private IPs."
  },
  {
    topic: "Cloud Networking",
    question: "VPC peering is:",
    options: ["Connecting two VPCs to route traffic privately", "An internet VPN", "AWS Direct Connect", "Subnet routing only"],
    correct: 0,
    explanation: "VPC peering enables private network connectivity between two VPCs."
  },
  {
    topic: "Cloud Networking",
    question: "What is the main difference between VPN and Direct Connect for hybrid cloud?",
    options: ["VPN uses the public internet; Direct Connect is a dedicated private connection", "Direct Connect is wireless", "VPN is always faster", "There is no difference"],
    correct: 0,
    explanation: "Direct Connect provides consistent latency and bandwidth through a dedicated connection."
  },
  {
    topic: "Cloud Networking",
    question: "A Transit Gateway is used to:",
    options: ["Connect multiple VPCs and on-premises networks through a central hub", "Replace IAM", "Store data", "Cache content"],
    correct: 0,
    explanation: "Transit Gateway simplifies complex network architectures compared to many VPC peering connections."
  },

  {
    topic: "Cloud Security & IAM",
    question: "What is the main difference between a security group and a network ACL?",
    options: ["Security groups are stateful; network ACLs are stateless", "Network ACLs are stateful; security groups are stateless", "Both are stateful", "Both are stateless"],
    correct: 0,
    explanation: "Security groups automatically allow return traffic, while NACLs require explicit rules for both directions."
  },
  {
    topic: "Cloud Security & IAM",
    question: "An IAM role is used to:",
    options: ["Store user passwords long-term", "Grant temporary permissions to users or services without static credentials", "Store data", "Encrypt data"],
    correct: 1,
    explanation: "IAM roles provide temporary credentials and help implement least privilege."
  },
  {
    topic: "Cloud Security & IAM",
    question: "The shared responsibility model means:",
    options: ["The customer owns all security", "The cloud provider secures infrastructure; the customer secures data, identity, and application configuration", "The provider owns all security", "Security costs are shared equally"],
    correct: 1,
    explanation: "The provider is responsible for security of the cloud; the customer is responsible for security in the cloud."
  },

  {
    topic: "Cloud Economics",
    question: "An SLA (Service Level Agreement) generally defines:",
    options: ["Security controls", "Committed service availability and performance, with credits if not met", "Data retention policy", "Pricing only"],
    correct: 1,
    explanation: "SLA is a provider commitment, usually expressed as uptime percentage with service credits."
  },
  {
    topic: "Cloud Economics",
    question: "An SLO is:",
    options: ["An internal target for service reliability, such as 99.95% availability", "A legal contract", "An error budget", "A support plan"],
    correct: 0,
    explanation: "SLO is a service level objective; SLI is the service level indicator used to measure it."
  },
  {
    topic: "Cloud Economics",
    question: "Moving from CapEx to OpEx in cloud means:",
    options: ["Buying more hardware upfront", "Shifting from upfront capital purchases to pay-as-you-go operating expenses", "There is no cost", "Only fixed monthly leases"],
    correct: 1,
    explanation: "Cloud consumption converts capital expenditure into flexible operating expenditure."
  },
  {
    topic: "Cloud Economics",
    question: "Total Cost of Ownership (TCO) in cloud should include:",
    options: ["Only virtual machine cost", "Hardware, facilities, power, licensing, operations, and downtime costs", "Only storage cost", "Only network cost"],
    correct: 1,
    explanation: "TCO compares all direct and indirect costs over the life of a solution."
  },
  {
    topic: "Cloud Economics",
    question: "A monthly cloud bill suddenly doubled. What is the first step to investigate?",
    options: ["Delete all resources immediately", "Use cost explorer and resource tags to identify cost drivers", "Ignore the increase", "Buy reserved instances immediately"],
    correct: 1,
    explanation: "Tagging and cost analytics help locate which team, service, or resource caused the increase."
  },
  {
    topic: "Cloud Economics",
    question: "Nightly batch jobs can tolerate interruption. Which pricing model is most cost-effective?",
    options: ["On-demand always-on VMs", "Spot or preemptible instances", "Dedicated hosts", "Reserved instances only"],
    correct: 1,
    explanation: "Spot/preemptible instances are deeply discounted and suitable for fault-tolerant batch workloads."
  },

  {
    topic: "Cloud Storage",
    question: "Which storage type is best for large unstructured objects like images and videos?",
    options: ["Block storage", "Object storage", "File storage", "RAM"],
    correct: 1,
    explanation: "Object storage is highly scalable and ideal for unstructured data with metadata."
  },
  {
    topic: "Cloud Storage",
    question: "Block storage is typically used for:",
    options: ["Operating system disks and databases requiring low latency", "Static website assets", "Data lakes", "Archival only"],
    correct: 0,
    explanation: "Block storage provides raw disk volumes attached to virtual machines for low-latency workloads."
  },
  {
    topic: "Cloud Storage",
    question: "A data lake is designed to:",
    options: ["Store only processed structured data for BI", "Store raw data in its native format at any scale, including unstructured data", "Replace a data warehouse entirely", "Store only logs for 30 days"],
    correct: 1,
    explanation: "Data lakes store raw data; data warehouses store processed, structured data for analytics."
  },
  {
    topic: "Cloud Storage",
    question: "A static website with global users and large media files should use:",
    options: ["Object storage + CDN", "A single large VM", "An on-premises server", "A dedicated database only"],
    correct: 0,
    explanation: "Object storage stores static files cheaply; a CDN caches them closer to users for low latency."
  },

  {
    topic: "Cloud Databases",
    question: "A managed database service means:",
    options: ["You install the database on a VM yourself", "The provider handles patching, backups, and high availability; you manage data and schema", "No administration is ever needed", "It is only available on-premises"],
    correct: 1,
    explanation: "Managed databases reduce operational overhead while you retain control of data and schema."
  },
  {
    topic: "Cloud Databases",
    question: "NoSQL databases are often chosen for:",
    options: ["Complex joins and strict ACID transactions only", "Horizontal scaling and flexible schema for high-velocity or unstructured data", "Only very small datasets", "Replacing all SQL databases"],
    correct: 1,
    explanation: "NoSQL scales horizontally and handles flexible or semi-structured data well."
  },

  {
    topic: "Cloud DevOps",
    question: "CI/CD stands for:",
    options: ["Continuous Installation / Continuous Deployment", "Continuous Integration / Continuous Delivery or Deployment", "Code Integration / Code Delivery", "Cloud Infrastructure / Cloud Deployment"],
    correct: 1,
    explanation: "CI/CD automates building, testing, and releasing software."
  },
  {
    topic: "Cloud DevOps",
    question: "Kubernetes is primarily used for:",
    options: ["Virtualization hypervisor", "Container orchestration: deployment, scaling, and self-healing", "Object storage", "DNS services"],
    correct: 1,
    explanation: "Kubernetes manages containerized workloads, handling scheduling, scaling, and recovery."
  },

  {
    topic: "Cloud Governance",
    question: "A Cloud Adoption Framework (CAF) primarily helps with:",
    options: ["Writing application code", "Organizing people, process, and technology for cloud adoption", "Network routing", "Database tuning"],
    correct: 1,
    explanation: "CAF provides guidance across business, people, governance, platform, security, and operations."
  },
  {
    topic: "Cloud Governance",
    question: "Cloud governance using Organizational Units (OUs) and Service Control Policies (SCPs) allows:",
    options: ["Centralized permission guardrails across multiple accounts", "Faster network routing", "Data encryption only", "Object storage management"],
    correct: 0,
    explanation: "SCPs enforce permission boundaries at the OU or account level for governance."
  },
  {
    topic: "Cloud Governance",
    question: "A company must store customer data in a specific country due to data residency laws. What is most important?",
    options: ["Choose a cloud region in that country or jurisdiction", "Use a global CDN", "Use multiple regions randomly", "Encrypt data only"],
    correct: 0,
    explanation: "Region selection determines where data is stored at rest, which is critical for compliance."
  },
  {
    topic: "Cloud Governance",
    question: "Multiple teams need guardrails preventing deletion of production resources and restricting regions. What should be used?",
    options: ["Service Control Policies / Organization policies", "Tags only", "Firewall rules only", "Load balancers"],
    correct: 0,
    explanation: "SCPs or organization policies enforce permission boundaries across multiple accounts."
  },

  {
    topic: "Cloud Migration",
    question: "Which migration strategy is known as \"rehost\"?",
    options: ["Lift and shift to cloud VMs with minimal changes", "Rewriting as cloud-native", "Retiring the application", "Replacing with SaaS"],
    correct: 0,
    explanation: "Rehost is the fastest migration approach, often lower risk and minimal code changes."
  },
  {
    topic: "Cloud Migration",
    question: "The \"6 R's\" of migration include:",
    options: ["Rehost, Replatform, Repurchase, Refactor, Retire, Retain", "Read, Write, Run, Repeat", "Route, Resolve, Restart", "Rehost only"],
    correct: 0,
    explanation: "These strategies help organizations choose the best migration path for each application."
  },
  {
    topic: "Cloud Migration",
    question: "Replatform differs from rehost because replatform involves:",
    options: ["No changes at all", "Some cloud optimizations without changing core architecture, such as using a managed database", "A full application rewrite", "Retiring the application"],
    correct: 1,
    explanation: "Replatform is sometimes called \"lift, tinker and shift\"; you keep the core but make targeted optimizations."
  },
  {
    topic: "Cloud Migration",
    question: "Which phase comes first in a typical migration project?",
    options: ["Migrate", "Assess and plan", "Optimize", "Decommission only"],
    correct: 1,
    explanation: "Migration begins with discovery, assessment, and planning to understand dependencies and TCO."
  },
  {
    topic: "Cloud Migration",
    question: "To migrate a database with minimal downtime, the best practice is to:",
    options: ["Stop the database, copy it, then start it again", "Use database replication or change data capture to keep source and target in sync before cutover", "Manually export and import with no replication", "Change DNS only"],
    correct: 1,
    explanation: "Replication or CDC keeps the target near-synced, enabling a short cutover window."
  },
  {
    topic: "Cloud Migration",
    question: "A legacy on-premises application must migrate quickly with minimal changes. Which strategy is best?",
    options: ["Rehost / lift and shift", "Refactor into microservices", "Repurchase as SaaS", "Retire"],
    correct: 0,
    explanation: "Rehost is the fastest migration path with minimal code changes and lower risk."
  },
  {
    topic: "Cloud Migration",
    question: "A critical database migration requires less than 5 minutes of downtime. Which approach is best?",
    options: ["Stop the database, copy, and restart", "Continuous replication or CDC, then cutover", "Manual export and import only", "No replication"],
    correct: 1,
    explanation: "Replication keeps the target near-synced, enabling a very short final cutover."
  },

  {
    topic: "Cloud DevOps & IaC",
    question: "Infrastructure as Code (IaC) means:",
    options: ["Writing documentation only", "Managing and defining infrastructure through machine-readable code", "Manual console changes", "Only creating virtual machines"],
    correct: 1,
    explanation: "IaC enables versioning, repeatability, automation, and consistent infrastructure deployment."
  },
  {
    topic: "Cloud DevOps & IaC",
    question: "Which is an example of an IaC tool?",
    options: ["Terraform / AWS CloudFormation", "Jenkins", "Docker", "Kubernetes"],
    correct: 0,
    explanation: "Terraform and CloudFormation define cloud resources declaratively as code."
  },
  {
    topic: "Cloud DevOps & IaC",
    question: "Configuration management tools such as Ansible are used to:",
    options: ["Provision cloud resources only", "Automate software installation, configuration, and state enforcement on servers", "Orchestrate containers", "Monitor logs only"],
    correct: 1,
    explanation: "Tools like Ansible, Chef, and Puppet manage desired configuration at the OS/application level."
  },
  {
    topic: "Cloud DevOps & IaC",
    question: "A typical CI/CD pipeline includes:",
    options: ["Automatically triggered build, test, and deploy stages on code changes", "Only manual approvals", "Only storage provisioning", "Only monitoring"],
    correct: 0,
    explanation: "CI/CD automates the software delivery process from code commit to deployment."
  },
  {
    topic: "Cloud DevOps & IaC",
    question: "What is blue-green deployment?",
    options: ["Running two identical environments; deploy the new version to the green environment, test, then switch traffic from blue", "Deploying to all instances at once", "Deleting the old version first", "Manual rollback only"],
    correct: 0,
    explanation: "Blue-green reduces downtime and risk by switching traffic after validating the new environment."
  },
  {
    topic: "Cloud DevOps & IaC",
    question: "Canary deployment means:",
    options: ["Releasing a new version to a small subset of users first to validate before broad rollout", "Releasing to all users at once", "Blue-green deployment only", "Retiring the old version"],
    correct: 0,
    explanation: "Canary releases reduce risk by exposing a small group to new changes first."
  },

  {
    topic: "Cloud Operations",
    question: "Observability differs from monitoring because observability:",
    options: ["Enables understanding internal system state from metrics, logs, and traces, not just collecting metrics", "Is only logs", "Is the same as monitoring", "Is only dashboards"],
    correct: 0,
    explanation: "Observability combines telemetry data to help answer why a system behaves a certain way."
  },
  {
    topic: "Cloud Operations",
    question: "Centralized logging in cloud is important for:",
    options: ["Increasing storage speed", "Correlating events across distributed services for troubleshooting and audit", "Always reducing cost", "Managing DNS"],
    correct: 1,
    explanation: "Centralized logs enable search, alerting, root cause analysis, and compliance."
  },

  {
    topic: "Cloud Practice Scenarios",
    question: "A startup expects highly variable traffic and wants no server management with cost proportional to usage. Which architecture fits best?",
    options: ["Large fixed virtual machines", "Serverless functions and managed services", "On-premises servers", "Dedicated hosts only"],
    correct: 1,
    explanation: "Serverless services scale automatically and bill per invocation, matching variable traffic and reducing cost."
  },
  {
    topic: "Cloud Practice Scenarios",
    question: "An e-commerce site expects a 10x traffic spike on Black Friday. What is the best combination?",
    options: ["Auto Scaling group + load balancer + CDN", "A single large server", "Static hosting only", "Manual scaling after the spike"],
    correct: 0,
    explanation: "Auto Scaling adjusts capacity automatically, the load balancer distributes traffic, and the CDN caches content."
  },

  {
    topic: "Cloud Security",
    question: "Exposed cloud API keys are found in a public repository. What should be done immediately?",
    options: ["Revoke or rotate the keys, use temporary credentials or a secrets manager, and review logs", "Wait for the next release", "Encrypt the repository with the same key", "Add the key to another repository"],
    correct: 0,
    explanation: "Revoking compromised credentials first prevents unauthorized access; then harden the process."
  },
];
